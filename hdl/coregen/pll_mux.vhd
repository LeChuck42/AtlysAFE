...
-- Module  Version: 5.6
--C:\lscc\diamond\3.2_x64\ispfpga\bin\nt64\scuba.exe -w -n pll_mux -lang vhdl -synth synplify -arch xo2c00 -type pll -fin 250 -fclkop 250 -fclkop_tol 0.0 -fclkos 250 -fclkos_tol 0.0 -fclkos2 50 -fclkos2_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 90 -trims_r -phases2 0 -phase_cntl STATIC -fb_mode 1 -lock 

-- Tue Oct 14 18:34:20 2014
...
entity pll_mux is
 ...
 attribute dont_touch of pll_mux : entity is true;
end pll_mux;
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_DIV=>  2, CLKOP_DIV=>  2, CLKFB_DIV=>  1, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
