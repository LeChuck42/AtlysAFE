...
-- Module  Version: 5.6
--C:\lscc\diamond\3.2_x64\ispfpga\bin\nt64\scuba.exe -w -n pll_main -lang vhdl -synth synplify -arch xo2c00 -type pll -fin 10 -fclkop 100 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1 -lock 
...
entity pll_main is
 ...
 attribute dont_touch of pll_main : entity is true;
end pll_main;
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_DIV=>  1, CLKOP_DIV=>  5, CLKFB_DIV=>  10, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of pll_main is
    for Structure
